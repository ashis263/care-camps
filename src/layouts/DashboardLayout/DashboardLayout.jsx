...
const DashboardLayout = () => {
    ...
    return (
        <div>
            <aside className="h-lvh sm:w-1/4 lg:w-1/5 bg-slate-200">
                ...
                </div>
                {
                    isAdmin
                    ?
                    <div className='flex flex-col mb-1 font-bold'>
                    ...
                    :
                    <div className='flex flex-col mb-16 font-bold'>
                        ...
                        <NavLink to="/dashboard/participantProfile" className="w-11/12 py-3 rounded-r-full pl-5 font-normal flex items-center gap-5"><IoPersonOutline /> Profile</NavLink>
                ...
                <div className='flex flex-col pl-2 text-primary font-bold absolute bottom-10'>
