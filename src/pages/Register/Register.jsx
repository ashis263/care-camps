        ...
        <div>
            <div className="flex flex-col mb-10">
                <form onSubmit={handleSubmit(submitForm)} className="w-11/12 mx-auto bg-white p-10 rounded-xl shadow">
                    ...
                    <p className="text-gray-400 text-center mb-2">Create with email and password</p>
                    ...
                    <div className="form-control mt-6">
                        <button className="btn max-lg:btn-sm hover:bg-[#000c] border-none bg-black text-white lg:text-xl">Create</button>
                    </div>
